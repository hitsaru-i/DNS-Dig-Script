...
# A list of the flags we'll call for this script. We can add other dig options like mx or txt to increase
# calls and data. Defaults according to specification are 'A' and 'CNAME'.
digflags = ['a','cname']
...
if __name__ == "__main__":
	print ("..Start..")
	#Assuming the document may seperate domains by a combination of new lines and commas, we loop both lines and
	# split the list by commas so that we can iterate through each domain
	for line in tldlist:
#		print (line)
